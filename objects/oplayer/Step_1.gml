if (!global.gamePaused)
{
	...
	{
		if (room == Level1 || room == Level2 || room == Level3 || room == AfterLevel3 || room == Level4 || room == Level5 || room == Level6 || room == Level7 || room == AfterLevel7 || room == GoingToBoss || room == LevelBoss)
	...
	if (room == GoingToBoss && global.playerHP < oPlayer.HP_max && !global.gamePaused)
	{
